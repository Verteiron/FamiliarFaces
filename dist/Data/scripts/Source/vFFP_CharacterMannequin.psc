Scriptname vFFP_CharacterMannequin extends vFFC_Doppelganger
{Removes functions that Shrine mannequins will never need.}

; === [ vFFP_CharacterMannequin.psc ] =====================================---
; Specialized version of vFFC_Doppelganger for use with Alcove statues. 
...
;Overrides vFFC_Doppelganger@OnUpdate
Event OnUpdate()
	If NeedUpkeep
		DoUpkeep(False)
	EndIf
...
;Overrides vFFC_Doppelganger@OnAnimationEvent
...
;Overrides vFFC_Doppelganger@OnObjectEquipped
Event OnObjectEquipped(Form akBaseObject, ObjectReference akReference)
EndEvent

;Overrides vFFC_Doppelganger@OnObjectUnequipped
Event OnObjectUnequipped(Form akBaseObject, ObjectReference akReference)
EndEvent

;=== Function from vFFC_Doppelganger that are altered ===--

Auto State Available
	;Overrides vFFC_Doppelganger@OnLoad
	Event OnLoad()
		;Clear out because we shouldn't be loaded
	EndEvent
	
	;Overrides vFFC_Doppelganger@AssignCharacter
...
State Assigned
	;Overrides vFFC_Doppelganger@OnBeginState
	Event OnBeginState()
	...
	Event OnUpdate()
		...
		If !NeedAppearance && !NeedEquipment
			SendModEvent("vFFP_CharacterReadyDisplay")
		EndIf
		If NeedStats
			If UpdateStats() >= 0
				NeedStats = False
...
;Overrides vFFC_Doppelganger@DoUpkeep
...
;Overrides vFFC_Doppelganger@UpdateInventory
...
;Overrides vFFC_Doppelganger@UpdateStats
...
;Overrides vFFC_Doppelganger@Perks
...
;Overrides vFFC_Doppelganger@UpdateShouts
Int Function UpdateShouts()
	Return 1
EndFunction

;Overrides vFFC_Doppelganger@RemoveCharacterShouts
...
;Overrides vFFC_Doppelganger@UpdateSpells
...
Function DebugTrace(String sDebugString, Int iSeverity = 0)
	...
	EndIf
	If CharacterName
		Debug.Trace("vFF/Mannequin/" + _sFormID + "(" + CharacterName + "): " + sDebugString,iSeverity)
		FFUtils.TraceConsole(sDebugString)
	Else
		Debug.Trace("vFF/Mannequin/" + _sFormID + ": " + sDebugString,iSeverity)
		FFUtils.TraceConsole(sDebugString)
	EndIf
EndFunction
