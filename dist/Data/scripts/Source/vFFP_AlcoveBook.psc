Scriptname vFFP_AlcoveBook extends ObjectReference
...
Activator						Property	vFFP_AlcoveControllerActivator				Auto
vFFP_AlcoveController			Property	AlcoveController							Auto Hidden
	
Actor							Property	PlayerREF									Auto
	
EffectShader					Property	GlowFXS										Auto

Explosion						Property	vFFP_BookDustExplosion						Auto

Form							Property	vFFP_BookGlow								Auto ;MovableStatic

Message							Property 	vFFP_ShrineBookSelfNewSaveMenu				Auto
Message							Property 	vFFP_ShrineBookSelfUpdateSaveMenu			Auto
Message							Property 	vFFP_ShrineBookSelfUpdateSaveConfirmMenu	Auto
Message							Property 	vFFP_ShrineBookSelfEraseConfirmMenu			Auto
Message							Property 	vFFP_ShrineBookSelfWrongShrineMenu			Auto
Message							Property 	vFFP_ShrineBookAltTakeItMenu				Auto
Message							Property 	vFFP_ShrineBookAltReturnItMenu				Auto
Message							Property	vFFP_ShrineBookAltReturnItConfirmMenu		Auto

Sound 							Property	vFFP_BookSlamSM 							Auto
Sound 							Property 	vFFP_BookWhooshSM							Auto
...
Function CheckObjects()
	...
	EndIf
	If !_kBookShine
		_kBookShine = PlaceAtMe(vFFP_BookGlow,abInitiallyDisabled = True)
...
Function FindObjects()
	AlcoveController = FindClosestReferenceOfTypeFromRef(vFFP_AlcoveControllerActivator,Self,1500) as vFFP_AlcoveController
...
Function OpenBook()
	...
	Wait(0.25)
	_kBookStatic.PlaceAtMe(vFFP_BookDustExplosion)
	Wait(0.25)
	vFFP_BookWhooshSM.Play(_kBookStatic)
...
Function CloseBook()
	...
	_kBookStatic.PlaceAtMe(vFFP_BookDustExplosion)
	Wait(0.5)
	vFFP_BookSlamSM.Play(_kBookStatic)
	Wait(0.25)
