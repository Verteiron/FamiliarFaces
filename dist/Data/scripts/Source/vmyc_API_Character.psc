...
Race Function GetCharacterRace(String asSID) Global
	...
	Return vMYC_API_Character.GetCharacterForm(asSID,sKey) as Race
EndFunction
...
Int Function GetCharacterSex(String asSID) Global
	...
	Return vMYC_API_Character.GetCharacterInt(asSID,sKey)
EndFunction
...
CombatStyle Function GetCharacterCombatStyle(String asSID) Global
	String sKey = ".Class"
	Return vMYC_API_Character.GetCharacterForm(asSID,sKey) as CombatStyle
EndFunction

; Return an array of all perks on a saved character. 
Form[] Function GetCharacterPerks(String asSID) Global
	String sKey = ".Perks"
	Int jPerksArray = vMYC_API_Character.GetCharacterObj(asSID,sKey)
...
Form[] Function GetCharacterSpells(String asSID) Global
	String sKey = ".Spells"
	Int jSpellsArray = vMYC_API_Character.GetCharacterObj(asSID,sKey)
...
Form[] Function GetCharacterShouts(String asSID) Global
	String sKey = ".Shouts"
	Int jShoutsArray = vMYC_API_Character.GetCharacterObj(asSID,sKey)
...
Form[] Function GetCharacterInventory(String asSID, Int aiType) Global
	...
	Int jInventoryFormMap = vMYC_API_Character.GetCharacterObj(asSID,sKey)
...
Form[] Function GetCharacterArmor(String asSID) Global
	...
	Int jArmorsArray = vMYC_API_Character.GetCharacterObj(asSID,sKey)
...
Form Function GetCharacterEquippedForm(String asSID, Int aiLocation) Global
	...
	Return vMYC_API_Character.GetCharacterForm(asSID,sKey)
EndFunction
...
Int Function SetCharacterLevel(String asSID, Float afValue) Global
	String sKey = ".Info.Level"
	Return vMYC_API_Character.SetCharacterFlt(asSID,sKey,afValue)
EndFunction
...
Int Function SetCharacterName(String asSID, String asValue) Global
	String sKey = ".Info.Name"
	Return vMYC_API_Character.SetCharacterStr(asSID,sKey,asValue)
EndFunction
...
Int Function SetCharacterSex(String asSID, Int aiValue) Global
	String sKey = ".Info.Sex"
	Return vMYC_API_Character.SetCharacterInt(asSID,sKey,aiValue)
EndFunction
