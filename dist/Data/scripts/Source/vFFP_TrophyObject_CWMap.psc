Scriptname vFFP_TrophyObject_CWMap extends vFFP_TrophyObject
...
Bool					Property	FlagsPlaced						Auto Hidden
Int						Property	LocationIndex					Auto Hidden
...
Event OnLoad()
	...
	EndIf
	If AlcoveController && !FlagsPlaced
		RemoveFlags()
		PlaceFlags()	
	EndIf
EndEvent
...
objectReference Function TryToPlaceFlag(ObjectReference RefOfFlag, Activator ActivatorOfFlagRed, Activator ActivatorOfFlagBlue, Location LocationOfFlag, String NodeOfFlag)
	...
	elseif iCWOwner == 2
		RefOfFlag = PlaceAtMe(ActivatorOfFlagBlue,abInitiallyDisabled = True)
		RefOfFlag.MoveToNode(self, NodeOfFlag)
	endif
	If RefOfFlag
