...
Event OnGameReload()
	CheckVars()
	RegisterForModEvent("vMYC_CompatCheck","OnCompatCheck")
	RegisterForModEvent("vMYC_CompatSelfMessage" + ModuleName,"OnCompatSelfMessage")
...
Event OnCompatCheck(Form akSender)
	...
	ElseIf !bIsRequired && Enabled
		_StopModule()
	EndIf
	Int iHandle = ModEvent.Create("vMYC_CompatReport")
	If iHandle
...
Function SendSelfMessage(String asMessage)
	Int iHandle = ModEvent.Create("vMYC_CompatSelfMessage" + ModuleName)
	If iHandle
...
Function DebugTrace(String sDebugString, Int iSeverity = 0)
	Debug.Trace("MYC/Compat/" + ModuleName + ": " + sDebugString,iSeverity)
EndFunction
